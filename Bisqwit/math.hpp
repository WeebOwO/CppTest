...
#else
// This wonâ€™t even compile. Worth a shot thoughâ€¦
...
public:
    ...
    {
        // Calculate the normal of the plane: (b-a)Ã—(c-a)
    ...
    auto DistanceTo(const auto& point) const { return Dot(normal, point) - distance; } // (normal Â· point) - distance
